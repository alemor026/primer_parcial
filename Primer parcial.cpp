...
void abrir_trabajador(){
	...
	cout << "id" <<"|"<< "CODIGO" <<"|"<< "NOMBRE"<<"| "<<"APELLIDO"<<"| "<<"SUELDO "<<"| "<<"SUELDO (con bonificacion de Q.250.00)"<<" "<<endl;	
		do{
		cout<<"_______________________________________________________________________________________________________________________"<<endl;
		cout << registro <<"  |  "<< trabajador.codigo <<" | "<< trabajador.nombre<<" | "<<trabajador.apellido<<" | "<< trabajador.sueldo<<" | "<< trabajador.sueldo+250<<endl;
...
void modificar_trabajador(){
	...
	FILE* archivo = fopen(nombe_archivo, "r+b");
		...
		cout << "Ingrese el ID que desea Modificar: ";
    		cin >> id;
    		fseek ( archivo, id * sizeof(Trabajador), SEEK_SET );  // esto es lo que permite modificar en la pocision
